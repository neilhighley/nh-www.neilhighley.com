...
var SIDPlayerPlugin = function (pluginManager)
{
    Phaser.Plugins.BasePlugin.call(this, pluginManager);
    this.endcallback=()=>{console.log("JSSID End callback")};
    this.startcallback=()=>{console.log("JSSID Start callback")};
    bufferlen = 16384;
    ...
    SIDPlayerPlugin.prototype = Object.create(Phaser.Plugins.BasePlugin.prototype);
    SIDPlayerPlugin.prototype.constructor = SIDPlayerPlugin;
